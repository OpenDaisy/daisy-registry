...
class RegistryClient(BaseClient):
    ...
    def get_host_clusters(self, host_id):
        """Return a list of membership associations from Registry."""
        res = self.do_request("GET", "/multi-clusters/nodes/%s" % host_id)
        data = jsonutils.loads(res.read())['multi-clusters']
        return data
    ...
    def get_networks_detailed(self, cluster_id):
        """
        Returns a list of detailed host data mappings from Registry
        ...
        res = self.do_request("GET", "/clusters/%s/networks" % cluster_id)
