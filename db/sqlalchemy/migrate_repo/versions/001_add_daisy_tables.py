...
def define_clusters_table(meta):
    clusters = Table('clusters',
                     ...
                     Column('id', String(36), primary_key=True,
                            nullable=False),
                     Column('name', String(255), default='TECS', nullable=False),
                     ...
                     Column('auto_scale', Integer(), nullable=False, default=0),
                     Column('created_at', DateTime(), nullable=False),
                     Column('updated_at', DateTime(), nullable=False),
                     Column('deleted_at', DateTime()),
                     Column('deleted',
...
def define_networks_table(meta):
    networks = Table('networks',
                     ...
                     Column('vlan_start', Integer(),nullable=False, default=0),
                     Column('vlan_end', Integer(),nullable=False, default=0),
...
def define_host_interfaces_table(meta):
    host_interfaces = Table('host_interfaces',
                     ...
                     Column('type', String(32),nullable=False, default='ether'),
...
def define_services_table(meta):
    services = Table('services',
                     ...
                     Column('id', String(36), primary_key=True,
                            nullable=False),
                     Column('name', String(255), nullable=False),
                     Column('component_id', String(36), ForeignKey('components.id'), nullable=True),
                     Column('description', Text()),
                     Column('backup_type', String(32), nullable=False, default='none'),
                     Column('created_at', DateTime(), nullable=False),
                     Column('updated_at', DateTime(), nullable=False),
                     Column('deleted_at', DateTime()),
                     Column('deleted',
...
def define_configs_table(meta):
    configs = Table('configs',
                     ...
                     Column('config_file_id', String(36), ForeignKey('config_files.id'), nullable=False),
...
def define_config_set_items_table(meta):
    config_set_items = Table('config_set_items',
                     ...
                     Column('id', String(36), primary_key=True,
                            nullable=False),
                     Column('config_set_id', String(36), ForeignKey('config_sets.id'),
                            nullable=False),
                     Column('config_id', String(36), ForeignKey('configs.id'), nullable=False),
                     Column('created_at', DateTime(), nullable=False),
                     Column('updated_at', DateTime(), nullable=False),
                     Column('deleted_at', DateTime()),
                     Column('deleted',
...
def define_logic_networks_table(meta):
    logic_networks = Table('logic_networks',
                  ...
                  Column('cluster_id', String(36), ForeignKey('clusters.id'), nullable=False),
                  Column('segmentation_id', BigInteger()),
                  Column('segmentation_type',  String(64), nullable=False),
...
def define_subnets_table(meta):
    subnets = Table('subnets',
                  ...
                  Column('gateway', String(128)),
                  Column('logic_network_id', String(36), ForeignKey('logic_networks.id'), nullable=False), 
                  Column('name',String(255), nullable=False),
